...
export   MY_ROOT_DIR=/home/taran/Documents/COAWSTworkshop/COAWST_v3_6/coawst_new
...
# etc).
  ...
  export     MY_HEADER_DIR=${MY_PROJECT_DIR}/Projects/Sed_floc_toy
  export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/Projects/Sed_floc_toy
...
if [ $cleanwrf -eq 1 ]; then
  ...
  export WRFHYDRO_DIR=${MY_ROMS_SRC}/WRF/hydro_v3.0
