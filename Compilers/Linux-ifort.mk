...
ifdef USE_WRFHYDRO
             FFLAGS += -I $(WRF_DIR)/hydro_v3.0/Land_models/NoahMP/IO_code
#             LIBS   += $(WRF_DIR)/hydro_v3.0/Land_models/NoahMP/Run/Noah_hrldas_beta_lib.a
             LIBS +=  $(WRF_DIR)/hydro_v3.0/Land_models/NoahMP/IO_code/module_NoahMP_hrldas_driver.o
             LIBS +=  $(WRF_DIR)/hydro_v3.0/Land_models/NoahMP/IO_code/main_hrldas_driver.o
             LIBS +=  $(WRF_DIR)/hydro_v3.0/Land_models/NoahMP/IO_code/module_hrldas_netcdf_io.o 
             LIBS +=  $(WRF_DIR)/hydro_v3.0/Land_models/NoahMP/Noah/module_sf_noahmpdrv.o
             LIBS +=  $(WRF_DIR)/hydro_v3.0/Land_models/NoahMP/Noah/module_sf_noahmplsm.o
             LIBS +=  $(WRF_DIR)/hydro_v3.0/Land_models/NoahMP/Noah/module_sf_noahmp_glacier.o
             LIBS +=  $(WRF_DIR)/hydro_v3.0/Land_models/NoahMP/Noah/module_sf_noahmp_groundwater.o
             LIBS +=  $(WRF_DIR)/hydro_v3.0/Land_models/NoahMP/Noah/module_sf_myjsfc.o
             LIBS +=  $(WRF_DIR)/hydro_v3.0/Land_models/NoahMP/Noah/module_sf_sfclay.o
             LIBS +=  $(WRF_DIR)/hydro_v3.0/Land_models/NoahMP/Utility_routines/module_wrf_utilities.o
             LIBS +=  $(WRF_DIR)/hydro_v3.0/Land_models/NoahMP/Utility_routines/module_model_constants.o
             LIBS +=  $(WRF_DIR)/hydro_v3.0/Land_models/NoahMP/Utility_routines/module_date_utilities.o
             LIBS +=  $(WRF_DIR)/hydro_v3.0/Land_models/NoahMP/Utility_routines/kwm_string_utilities.o
             LIBS +=  $(WRF_DIR)/hydro_v3.0/CPL/COAWST_cpl/hydro_coupler.o
             LIBS += $(WRF_DIR)/hydro_v3.0/lib/libHYDRO.a
endif
